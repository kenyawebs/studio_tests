...
/**
 * The provider that wraps the application to enable toast notifications.
 * It should be rendered at the root of the application.
 */
const ToastProvider = ToastPrimitives.Provider

/**
 * The component that renders the viewport for toasts.
...
/**
 * Defines the visual styles for the Toast component variants.
 */
...
/**
 * The main component for a toast notification.
...
/**
 * An action button that can be rendered within a toast.
 ...
 * @returns {JSX.Element} The toast action component.
 */
...
/**
 * A button to close a toast notification.
 ...
 * @returns {JSX.Element} The toast close button.
 */
...
/**
 * The type for a ToastAction element.
 */
