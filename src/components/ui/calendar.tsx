 ...
 * Extends the props from the `react-day-picker` library.
 ...
 * This component is a styled wrapper around the `react-day-picker` library,
 * providing a consistent look and feel with the rest of the UI.
 *
